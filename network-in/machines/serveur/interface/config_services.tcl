...
proc fenetre_config_services {} {
    ...
    label .srv.ico -image img_config_serveur
    pack .srv.ico
    ...
    button .srv.q -compound left -text [::msgcat::mc "Close"] -image img_annuler -command {destroy .srv} -relief flat
    pack .srv.q
...
proc fenetre_config_dns {} {
    ...
    label .sdns.ico -image img_config_serveur
    pack .sdns.ico
    ...
    frame .sdns.fb
    pack .sdns.fb
    button .sdns.fb.v -compound left -text [::msgcat::mc "Confirm"] -image img_valider -relief flat -command {
        set ::conf_dns(dns_records) {}
    ...
    button .sdns.fb.a -compound left -text [::msgcat::mc "Abort"] -image img_annuler -relief flat -command {
        destroy .sdns
    }
...
proc fenetre_config_ftp {} {
    ...
    label .sftp.ico -image img_config_serveur
    pack .sftp.ico
    ...
    frame .sftp.fb
    pack .sftp.fb
    button .sftp.fb.v -compound left -text [::msgcat::mc "Confirm"] -image img_valider -relief flat -command {
        set ::conf_ftp(ftp_users) {}
    ...
    button .sftp.fb.a -compound left -text [::msgcat::mc "Abort"] -image img_annuler -command {destroy .sftp} -relief flat
...
proc fenetre_config_dhcp {} {
    ...
    label .sdhcp.ico -image img_config_serveur
    pack .sdhcp.ico
    ...
    frame .sdhcp.fb
    pack .sdhcp.fb
    button .sdhcp.fb.v -compound left -text [::msgcat::mc "Confirm"] -image img_valider -relief flat -command {
        applique_config_dhcp
        destroy .sdhcp
    }
    pack .sdhcp.fb.v -side left
    button .sdhcp.fb.a -compound left -text [::msgcat::mc "Abort"] -image img_annuler -command {destroy .sdhcp} -relief flat
...
proc fenetre_config_http {} {
    ...
    label .shttp.ico -image img_config_serveur
    pack .shttp.ico
    ...
    frame .shttp.fb
    pack .shttp.fb
    button .shttp.fb.v -compound left -text [::msgcat::mc "Confirm"] -image img_valider -relief flat -command {
    ...
    button .shttp.fb.a -compound left -text [::msgcat::mc "Abort"] -image img_annuler -command {destroy .shttp} -relief flat
...
proc fenetre_config_ssh {} {
    ...
    label .sssh.ico -image img_config_serveur
    pack .sssh.ico
    ...
    frame .sssh.fb
    pack .sssh.fb
    button .sssh.fb.v -compound left -text [::msgcat::mc "Confirm"] -image img_valider -relief flat -command {
        # on applique la config
        applique_config_ssh
        destroy .sssh
    }
    pack .sssh.fb.v -side left
    button .sssh.fb.a -compound left -text [::msgcat::mc "Abort"] -image img_annuler -command {destroy .sssh} -relief flat
